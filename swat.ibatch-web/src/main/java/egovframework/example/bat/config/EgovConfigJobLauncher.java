...
public class EgovConfigJobLauncher {
	...
	@Bean
	EgovBatchRunner batchRunner(JobOperator jobOperator, JobExplorer jobExplorer, JobRepository jobRepository) {
	...
	@Bean
	JobRepositoryFactoryBean jobRepository(DataSource dataSource, TransactionManager transactionManager,
	...
	@Bean
	SimpleJobOperator jobOperator(JobLauncher jobLauncher, JobExplorer jobExplorer, JobRepository jobRepository,
	...
	@Bean
	JobExplorerFactoryBean jobExplorer(DataSource datasource, TransactionManager transactionManager) {
